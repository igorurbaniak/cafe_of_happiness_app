...
part of 'dishes_remote_data_source.dart';
...
class _DishesRemoteRetrofitDataSource
  ...
  Future<List<DishModel>> getDishes() async {
    ...
    final _options = _setStreamType<List<DishModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
