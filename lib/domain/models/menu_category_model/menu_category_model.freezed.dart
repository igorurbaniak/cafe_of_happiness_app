...
class _$MenuCategoryModelImpl implements _MenuCategoryModel {
  _$MenuCategoryModelImpl({required this.id, required this.title});
  ...
  @override
  String toString() {
    return 'MenuCategoryModel(id: $id, title: $title)';
  }
...
abstract class _MenuCategoryModel implements MenuCategoryModel {
  factory _MenuCategoryModel(
      ...
      required final String title}) = _$MenuCategoryModelImpl;
